...
general_citizen read_from_file()
{
    ...
    date d1,d2;
    d1.day=22;d1.month=5;d1.year=2021;
...
class general_centre : public vaccination_centre
{
	...
	sinopharm *sp;
	pfizer *pf;
    int no_sputnik,no_cansino,no_sinopharm,no_pfizer;
    public:
        ...
        //getters
        int get_no_sinopharm(){return no_sinopharm;}
        int get_no_pfizer(){return no_pfizer;}
        int get_no_cansino(){return no_cansino;}
        int get_no_sputnik(){return no_sputnik;}
        //setters
        void set_pfizer(int n)
        {
            no_pfizer = n;
        }
        void set_cansino(int n)
        {
            no_cansino = n;
        }
        void set_sputnik(int n)
        {
            no_sputnik = n;
        }
        void set_sinopharm(int n)
        {
            no_sinopharm = n;
        }
        // copy constructor
        general_centre(const general_centre &g1)
        {
            name = g1.name;
            city = g1.city;
            province = g1.province;
            no_of_customers = g1.no_of_customers;
            cz = new general_citizen[no_of_customers];
            no_of_staff = g1.no_of_staff;
            pmd = new paramedical_staff[no_of_staff];
            no_pfizer = g1.no_pfizer;
            no_sinopharm = g1.no_sinopharm;
            no_sputnik = g1.no_sputnik;
            no_sputnik = g1.no_sputnik;
            pf = new pfizer[no_pfizer];
            sv = new sputnik_v[no_sputnik];
            sp  = new sinopharm[no_sinopharm];
            cb = new cansino_bio[no_cansino];
        }
};
